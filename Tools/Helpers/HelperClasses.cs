...
namespace APMTools
{
    public static class HelperClasses
    {
        ...
        #region Exception
        public class GNVException : Exception
        {
            public GNVException(string message) : base(message) { }
            public GNVException(string message, Exception innerException) : base(message, innerException) { }
