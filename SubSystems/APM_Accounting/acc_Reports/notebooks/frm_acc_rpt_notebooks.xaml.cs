...
{
    public partial class frm_acc_rpt_notebooks : WindowReport<stp_acc_rpt_notebooks_selResult>
    {
        #region Constructor
        public frm_acc_rpt_notebooks()
        {
            InitializeComponent();
            Initial_WindowReport(dh_balance, dbg_acc_rpt_account_balance, tbr_acc_rpt_account_balance, "acc_rpt_notebooks", new APM_SubSystems.APM_Accounting.acc_Reports.notebooks.rpt_acc_notebooks());
        }
        #endregion
        ...
        public override void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            selectedRecord.acc_rpt_notebooks_acc_document_type_id = null;
            MoveCollectionView();
        }
        #endregion
        ...
        {
            if (!(dataGrid.SelectedItem is stp_acc_rpt_notebooks_selResult))
                return;
            var record = dataGrid.SelectedItem as stp_acc_rpt_notebooks_selResult;
            new frm_acc_document().ShowOneDocument(record.acc_rpt_notebooks_acc_document_id);
        }
        #endregion 
